...
public class InfraestructureProjectTest {
    ...
    private InfraestructureProject p2;
    private InfraestructureProject p3;
    ...
    public void setUp(){
        ...
        p1 = new InfraestructureProject("P1", "Descripcion p1", 25000, "imagen1.jpg", "Distrito1", user1);
        p1.validate();
        
        // Se crea y se valida un proyecto
        p2 = new InfraestructureProject("P2", "Descripcion p2", 5000, "Imagen2.jpg", "Distrito2", user1);
        p2.validate();
        
        // Se crea y se valida un proyecto
        p3 = new InfraestructureProject("P3", "Descripcion p3", 50000, "Imagen3.jpg", "Distrito3", user2);
        p3.validate();
