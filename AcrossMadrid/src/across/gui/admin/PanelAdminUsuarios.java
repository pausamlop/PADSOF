...
public class PanelAdminUsuarios extends JPanel {
	...
	public PanelAdminUsuarios() {
		...
		/* Bloqueo de usuarios */
		/*
		 * layout.putConstraint(SpringLayout.HORIZONTAL_CENTER, bloqMensaje, -70,
		 * SpringLayout.HORIZONTAL_CENTER, this);
		 * layout.putConstraint(SpringLayout.VERTICAL_CENTER, bloqMensaje, -100,
		 * SpringLayout.VERTICAL_CENTER, this); layout.putConstraint(SpringLayout.EAST,
		 * bloq, -10, SpringLayout.WEST, bloqMensaje);
		 * layout.putConstraint(SpringLayout.VERTICAL_CENTER, bloq, -100,
