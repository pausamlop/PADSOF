 ...
 *
 */
public class ControladorSeguir implements ActionListener{
    ...
    /**
     * Constructor de la clase ControladorSeguir
     * 
     * @param frame pantalla principal de la aplicacion
     * @param model aplicacion(funcionamiento)
     */
    public ControladorSeguir (MainFrame frame, Application model){
        this.model = model;
        this.frame = frame;
    ...
    public void actionPerformed(ActionEvent e){
        panel.getProject().follow(model.getCurrentUser());
        panel.update();
    }
}